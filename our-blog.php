...
<main>
    ...
    <section class="py-5rem our-blog-area">
        <div class="container">
            <div class="row mb-5">
                <div class="col-12">
                ...
                <div class="col-12 col-lg-8">
                    <div class="economics-chart-slider-layer mb-5 mb-lg-0 m-0">
                        ...
                        <div class="economics-chart-text-area p-5">
                            ...
                            <a class="text-decoration-none watchlist-read-more text-decoration-none d-inline-block" href="blog-detail.php">
                                read more
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-12">
                            <div class="economics-chart-slider-layer mb-5 mb-lg-3  mx-0">
                                ...
                                <div class="economics-chart-text-area ">
                                    <a class="economics-chart-title text-white text-decoration-none trading-new-title" href="blog-detail.php">
            ...
            <div class="row pt-5">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="economics-chart-slider-layer mb-5 mx-0">
                        <div class="">
                            <img class="economics-chart-img w-100 img-fluid" src="./assets/images/elite-trading-bg.webp" alt="">
                        </div>
                        <div class="economics-chart-text-area ">
